        ...
        <div class="mt-3 border border-[#E5E3DB] bg-white">
            ...
            <dl class="divide-y divide-[#EFEDE6] text-sm">
                ...
                <div class="flex justify-between px-8 py-4">
                    ...
                    <dd class="font-medium text-[#16213A]">Budi Susanto</dd>
                </div>
                <div class="flex justify-between px-8 py-4">
                ...
                <div class="flex justify-between px-8 py-4">
                    <dt class="uppercase tracking-[0.1em] text-xs text-slate-400">Pelajaran</dt>
                    <dd class="font-medium text-[#16213A]">Akuntansi Dasar</dd>
                </div>
                <div class="flex justify-between px-8 py-4">
                    <dt class="uppercase tracking-[0.1em] text-xs text-slate-400">Telepon</dt>
